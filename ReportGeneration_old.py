...
class ReportGeneration:
    ...
    def generate_first_page(self):
        ...
        data1 = [ [nameLabel, self.cache.name, dateLabel, self.cache.date], [refLabel, self.cache.ref, ageLabel, self.cache.age], [cpLabel, self.cache.specialRemarks, idLabel, self.cache.id] ]
        ...
        data2 = [ [firstEntry, leftBreastLabel, self.cache.remarks[0]], ["", "", ""], [secondEntry, rightBreastLabel, self.cache.remarks[1]]  ]
        #t2 = Table(data2)
        t2 = Table(data2, colWidths=[1*inch, 1.5*inch, 4*inch], style=[ ("VALIGN", (0,0), (0,2), "TOP"), ("VALIGN", (1,0), (1,2), "TOP"), ("VALIGN", (2,0), (2,2), "TOP") ])
        ...
        data3 = [ [suggestLabel, self.cache.remarks[2]] ]
