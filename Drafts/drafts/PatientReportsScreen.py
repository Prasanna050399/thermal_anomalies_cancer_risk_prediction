...
# Form implementation generated from reading ui file 'patientReportsScreen.ui'
#
...
class Ui_patientReportScreen(object):
...
if __name__ == "__main__":
    ...
    patientReportScreen = QtWidgets.QMainWindow()
    ui = Ui_patientReportScreen()
    ui.setupUi(patientReportScreen)
    patientReportScreen.show()
    sys.exit(app.exec_())
