...
import Cache_demo import Cache
...
class Database:
    ...
    def getPatientVisitDataFromDB(self, patientId, visitDate):
        ...
        #return { "PatientID" : patientId, "VisitDate" : visitDate, "OriginalImages" : scans, "AnomalyImages" : anomalies, "EdgeImages" : edges, "DiagnosticScore" : diagnosticScore, "Remarks" : remarks, "NN" : nn }
        return { "PatientID" : patientId, "VisitDate" : visitDate, "OriginalImages" : scans, "AnomalyImages" : anomalies, "EdgeImages" : edges, "DiagnosticScore" : diagnosticScore, "Remarks" : remarks, "AsymmetryImage" : asymmetry, "NN" : nn } ##
