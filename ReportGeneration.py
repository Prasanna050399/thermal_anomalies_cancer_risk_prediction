...
class ReportGeneration:
    ...
    def generate_first_page(self):
        ...
        style.wordWrap = 'LTR'
        style.leading = 12
        cpField = Paragraph(self.cache.specialRemarks, style = style)##
        ...
        t1 = Table(data1, colWidths=[1.2*inch, 2.5*inch, 1.2*inch, 2.5*inch], style=[ ("GRID", (0, 0), (-1, -1), 1, colors.blue, None, (1, 1, 1)) , ("VALIGN", (0,0), (-1,-1), "MIDDLE") ])
        ...
        leftBreastField = Paragraph(self.cache.remarks[0].replace('\n','<br />\n'))
        rightBreastField = Paragraph(self.cache.remarks[1].replace('\n','<br />\n'))
        ...
        suggestField = Paragraph(self.cache.remarks[2].replace('\n','<br />\n'))
...
##    cache.age = "57"
##    cache.specialRemarks = "special  left breast findings so there used to exist 2 elements in the begining of this universe one was hydrogen and second was helium we can say that helium is the by product of hydrogen fussion this makes no sense because i have no knowledge about how space works and along with that i have no degree in astro physics well me nai rukne wala tu kuch bhi bol kewlani yash nai nai nai nai nian ian idnfijalskdjflsajdflkjaslkdfjlkasjdfjasdfljsadfjsjfdlkajsdkfjasdfjasdjfkjasdflkjkasdjflkasjdflkjsdjfvasjdfksjdfjaskdjfklasdjfasjd \nnew line\nthird line\nforth line\nfifth lineremark1\nnext line remark asjdlfjaslkjfdl kjsdkj flkasjflk jasjf jasf jasjdfk jaskdfj sjd "
...
##
##    cache.remarks = ["left breast findings so there used to exist 2 elements in the begining of this universe one was hydrogen and second was helium we can say that helium is the by product of hydrogen fussion this makes no sense because i have no knowledge about how space works and along with that i have no degree in astro physics well me nai rukne wala tu kuch bhi bol kewlani yash nai nai nai nai nian ian idnfijalskdjflsajdflkjaslkdfjlkasjdfjasdfljsadfjsjfdlkajsdkfjasdfjasdjfkjasdflkjkasdjflkasjdflkjsdjfvasjdfksjdfjaskdjfklasdjfasjd \nnew line\nthird line\nforth line\nfifth line", "right left breast findings so there used to exist 2 elements in the begining of this universe one was hydrogen and second was helium we can say that helium is the by product of hydrogen fussion this makes no sense because i have no knowledge about how space works and along with that i have no degree in astro physics well me nai rukne wala tu kuch bhi bol kewlani yash nai nai nai nai nian ian idnfijalskdjflsajdflkjaslkdfjlkasjdfjasdfljsadfjsjfdlkajsdkfjasdfjasdjfkjasdflkjkasdjflkasjdflkjsdjfvasjdfksjdfjaskdjfklasdjfasjd \nnew line\nthird line\nforth line\nfifth line findings\nnew line", "suggest left breast findings so there used to exist 2 elements in the begining of this universe one was hydrogen and second was helium we can say that helium is the by product of hydrogen fussion this makes no sense because i have no knowledge about how space works and along with that i have no degree in astro physics well me nai rukne wala tu kuch bhi bol kewlani yash nai nai nai nai nian ian idnfijalskdjflsajdflkjaslkdfjlkasjdfjasdfljsadfjsjfdlkajsdkfjasdfjasdjfkjasdflkjkasdjflkasjdflkjsdjfvasjdfksjdfjaskdjfklasdjfasjd \nnew line\nthird line\nforth line\nfifth linebreast findings asddddddddddddddajdfjalskjdfljas\\\nnew line\nthird line\nforth line\nfifth line"]
